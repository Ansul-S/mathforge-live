...
import { Menu, BrainCircuit, User } from "lucide-react";
import { Sheet, SheetContent, SheetTrigger } from "@/components/ui/Sheet";
import { ThemeToggle } from "@/components/ui/ThemeToggle";
import { useThemeStore } from "@/store/themeStore";
import { LoreDisplay } from "@/components/lore/LoreDisplay";
import { AchievementsModal } from "@/components/features/AchievementsModal";
                    ...
                    <div className="flex h-16 items-center justify-between px-4">
                        ...
                        <nav className="hidden xl:flex items-center space-x-6 text-sm font-medium">
                            ...
                            <Button
                                ...
                                className={cn(
                                    "gap-2",
                                    isSakura ? "text-gray-700 hover:text-sakura-primary" : "text-gray-300 hover:text-dragon-primary"
                                )}
                            >
